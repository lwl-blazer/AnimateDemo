...
- (void)creatMessageView{
    ...
    textLabel.text = text;
    textLabel.font = [UIFont HeitiSCWithFontSize:15.0f];
    ...
    self.messageView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.75];
    ...
    scale.toValue = [NSValue valueWithCGSize:CGSizeMake(1.0, 1.0)];
