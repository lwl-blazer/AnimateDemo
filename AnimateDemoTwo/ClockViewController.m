...
@property(nonatomic, assign) CGFloat hourCount;
@property(nonatomic, assign) CGFloat secondCount;
@property(nonatomic, assign) CGFloat minuteCount;
...
- (void)setup{
    ...
    NSDictionary *currentTime = [[SystemTimeInformation sharedInstance] currentTimeInformation];
    ...
    
    {
        ...
        circleRound.layer.cornerRadius = 250.f/2.0f;
